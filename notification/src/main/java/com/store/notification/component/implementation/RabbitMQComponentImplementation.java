package com.store.notification.component.implementation;

import com.store.notification.component.RabbitMQComponent;
import com.store.notification.service.implementation.EmailServiceImplementation;
...
@Component
public class RabbitMQComponentImplementation implements RabbitMQComponent {
    ...
    public RabbitMQComponentImplementation(WebClient webClient) {
